# Contributing to the Harmony Regridding Service
...
"[Jira Project]-XXXX - [Your commit message here]", for example:
"DAS-1234 - Add amazing feature to the Harmony Regridder."

## General coding practices:

This repository adheres to Python coding style recommendations from
[black](https://black.readthedocs.io/en/stable/). Additionally, type hints are
...
Harmony Regridding Service maintainers will review all pull requests submitted.
